...
const tseliteli = ['Баб','Бир','Гус','Дже','Дор','Мрк','Неб','Сел','Тея','Фаф','Мор','Май','Эйд',];
const magi = ['Авг','Айр','Альванор','Ами','Без','Бир','Гел','Кай','Кас','Кри','Крн','Лар','Лил','Лиэ','Май','Мод','Ори','Пеп','Пол','Сат','Сел','Суд','Фол','Хай','Фла','Фоб','Эйд',];
const boyci = ['Ара','Гал','Исм', 'К\'А','Кей','Лир','Лук','Три','Цин','Чер','Эль','Ясм'];
const strelki = ['Арт','Дан','Джи','Джу','Кир','ЛаК','Лук','Сор','ТЗв','Фок','Эль',];
const controls = ['Айз','Ара','Анд','Без', 'Йор','Лар','Лил','Лиэ','Лют','Пол','Суд','Тес','ТЗв','Фоб','Фаф','Чаб',];
const tanki = ['Авр','Аст','Гал','Зир','Крв','Лют','Муш','Руф','Тес','Чаб','Эле','Юли'];
const helpers = ['Айз','Альванор','Ами','Анд','Аст','Баб','Гел','Гус','Дор','Дже','Йор','Кас','Крн','Мрк','Мод','Мор','Неб','Пеп','Лир','Себ','Суд','Тея','Фаф','Фла'];
